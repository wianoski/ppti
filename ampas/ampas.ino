...
//const char* wifiSSID = "Foresty 101 Hack The Planet";
//const char* wifiPassword = "tanyapakparman";


//const char* wifiSSID = "StudioIoT";
//const char* wifiPassword = "tanyapakardian";

const char* wifiSSID = "Telematic Lab";
const char* wifiPassword = "telematic@fun";


// MQTT Define
//const char* mqttServerIP = "broker.hivemq.com";
const char* mqttServerIP = "10.30.40.23";
...
//  client.subscribe(topicLatihan1);
  ...
  client.publish(stat, "Initializing"); // acc
